# Installation
> `npm install --save @types/leaflet.chinatmsproviders`

# Summary
This package contains type definitions for leaflet.chinatmsproviders (https://github.com/htoooth/Leaflet.ChineseTmsProviders).

# Details
Files were exported from https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/leaflet.chinatmsproviders.
## [index.d.ts](https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/leaflet.chinatmsproviders/index.d.ts)
````ts
...
# Credits
These definitions were written by [TwoKe](https://github.com/TwoKe945).
